 ...
 * jeap-messaging-avro - [ch.admin.bit.jeap:jeap-messaging-avro](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-messaging/jeap-messaging-avro)
 * jeap-messaging-model - [ch.admin.bit.jeap:jeap-messaging-model](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-messaging/jeap-messaging-model)
 * jeap-spring-boot-application-starter - [ch.admin.bit.jeap:jeap-spring-boot-application-starter](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-spring-boot-starters/jeap-spring-boot-application-starter)
 * jeap-spring-boot-cloud-autoconfig-starter - [ch.admin.bit.jeap:jeap-spring-boot-cloud-autoconfig-starter](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-spring-boot-starters/jeap-spring-boot-cloud-autoconfig-starter)
 * jeap-spring-boot-logging-starter - [ch.admin.bit.jeap:jeap-spring-boot-logging-starter](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-spring-boot-starters/jeap-spring-boot-logging-starter)
 * jeap-spring-boot-rest-request-tracing - [ch.admin.bit.jeap:jeap-spring-boot-rest-request-tracing](https://spring.io/projects/spring-boot/jeap-internal-spring-boot-parent/jeap-spring-boot-starters/jeap-spring-boot-rest-request-tracing)
